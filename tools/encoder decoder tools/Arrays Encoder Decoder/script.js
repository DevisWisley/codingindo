...
function encodeBtn() {
    ...
    const encodedArrays = encodeToArrays(inputText);
...
function decodeFromArrays(arraysStr) {
    let hexArray = arraysStr.split('\n');
    let str = '';
...
function decodeBtn() {
    ...
    const decodedArrays = decodeFromArrays(encodedArrays);

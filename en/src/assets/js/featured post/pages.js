...
const codeJsonExplanations = [
    ...
    { code_language: "<b style='background-color: #ececec;'>su</b>", language_name: "<b style='background-color: #ececec;'>Basa Sunda (Indonésia)</b>", explanation_json: "Sundanese, spoken in <b style='background-color: #ececec;'>Indonesia</b> (West Java)." },

...
const codeHtmlExplanations = [
    ...
    { number: 2, code_html: "<b style='background-color: #ececec;'>&lt;html lang=\"en\"&gt;</b>", explanation_html: "The opening tag of an HTML element, with the <b style='background-color: #ececec;'>lang=\"en\"</b> attribute to indicate that the primary language of this document is English." },
    { number: 3, code_html: "<b style='background-color: #ececec;'>&lt;head&gt;</b>", explanation_html: "The opening tag of the head element, where the metadata declarations and CSS links are located." },
    { number: 4, code_html: "<b style='background-color: #ececec;'>&lt;meta charset=\"UTF-8\"&gt;</b>", explanation_html: "Meta tag to define character encoding as UTF-8, allowing support for a wide range of worldwide characters." },
    { number: 5, code_html: "<b style='background-color: #ececec;'>&lt;meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"&gt;</b>", explanation_html: "Meta tag to make a page responsive on mobile devices, by setting the initial scale of the page to 100%." },
    { number: 6, code_html: "<b style='background-color: #ececec;'>&lt;title&gt;Currency Converter&lt;/title&gt;</b>", explanation_html: "State the page title as \"Currency Converter\"." },
    { number: 7, code_html: "<b style='background-color: #ececec;'>&lt;link rel=\"stylesheet\" href=\"style.css\"&gt;</b>", explanation_html: "Links to an external CSS file named \"style.css\" for additional styling." },
    { number: 8, code_html: "<b style='background-color: #ececec;'>&lt;link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css\" rel=\"stylesheet\"&gt;</b>", explanation_html: "Linking to Bootstrap 5 CDN for pre-configured component styling." },
    { number: 9, code_html: "<b style='background-color: #ececec;'>&lt;link href=\"https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css\" rel=\"stylesheet\"&gt;</b>", explanation_html: "Linking to TailwindCSS CDN version 2.2.19 for utility-based styling." },
    { number: 10, code_html: "<b style='background-color: #ececec;'>&lt;body class=\"bg-gray-50\"&gt;</b>", explanation_html: "Open <b style='background-color: #ececec;'>body</b> tag with class <b style='background-color: #ececec;'>bg-gray-50</b> from TailwindCSS to provide a light gray background." },
    { number: 11, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"container mt-5\"&gt;</b>", explanation_html: "Create a <b style='background-color: #ececec;'>container</b> div for the main content with a top margin (mt-5) to give it some distance from the top of the page." },
    { number: 12, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"card shadow p-5 rounded-xl border-0\"&gt;</b>", explanation_html: "Create a card with a shadow, padding 5, rounded corners (rounded-xl), and no border." },
    { number: 13, code_html: "<b style='background-color: #ececec;'>&lt;h2 class=\"text-center mb-5 text-3xl font-extrabold text-gray-800\"&gt;Currency Converter&lt;/h2&gt;</b>", explanation_html: "Displays the app title in the center of the page in a large, bold style and dark gray." },
    { number: 14, code_html: "<b style='background-color: #ececec;'>&lt;form id=\"converter-form\"&gt;</b>", explanation_html: "Opens a form with <b style='background-color: #ececec;'>id=\"converter-form\"</b> for currency conversion." },
    { number: 15, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"mb-4\"&gt;</b>", explanation_html: "Create a div with a bottom margin (mb-4) to set the spacing between form elements." },
    { number: 16, code_html: "<b style='background-color: #ececec;'>&lt;label for=\"amount\" class=\"form-label text-gray-700 font-medium\"&gt;Amount&lt;/label&gt;</b>", explanation_html: "Create a label for the amount input, with dark gray text color and medium font." },
    { number: 17, code_html: "<b style='background-color: #ececec;'>&lt;input type=\"number\" class=\"form-control rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500\" id=\"amount\" placeholder=\"Enter amount\" required&gt;</b>", explanation_html: "Create a number type input to enter the amount to be converted, with large rounded styling, light gray border color, and blue ring effect when clicked." },
    { number: 18, code_html: "<b style='background-color: #ececec;'>&lt;label for=\"from-currency\" class=\"form-label text-gray-700 font-medium\"&gt;From&lt;/label&gt;</b>", explanation_html: "Label for the initial currency dropdown select (source)." },
    { number: 19, code_html: "<b style='background-color: #ececec;'>&lt;select class=\"form-select rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500\" id=\"from-currency\"&gt;</b>", explanation_html: "Dropdown to select the initial currency (source) with a blue focus effect." },
    { number: 20, code_html: "<b style='background-color: #ececec;'>&lt;option value=\"USD\" selected&gt;USD - United States Dollar&lt;/option&gt;</b>", explanation_html: "Displays the available currency options in a dropdown, with the default option being <b style='background-color: #ececec;'>USD</b>." },
    { number: 21, code_html: "<b style='background-color: #ececec;'>&lt;label for=\"to-currency\" class=\"form-label text-gray-700 font-medium\"&gt;To&lt;/label&gt;</b>", explanation_html: "Label for the destination currency dropdown select." },
    { number: 22, code_html: "<b style='background-color: #ececec;'>&lt;select class=\"form-select rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500\" id=\"to-currency\"&gt;</b>", explanation_html: "Dropdown to select the destination currency." },
    { number: 23, code_html: "<b style='background-color: #ececec;'>&lt;option value=\"USD\"&gt;USD - United States Dollar&lt;/option&gt;</b>", explanation_html: "Displays available currency options in the destination dropdown." },
    { number: 24, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"text-center\"&gt;</b>", explanation_html: "Create a div to center the button." },
    ...
    { number: 26, code_html: "<b style='background-color: #ececec;'>&lt;div id=\"result\" class=\"text-center mt-4 text-gray-800 text-xl font-bold\"&gt;&lt;/div&gt;</b>", explanation_html: "Div to display the conversion results at the bottom with large and bold font." },
    { number: 27, code_html: "<b style='background-color: #ececec;'>&lt;script src=\"script.js\"&gt;&lt;/script&gt;</b>", explanation_html: "Link external JavaScript file \"style.css\" to add conversion functionality." },
    { number: 28, code_html: "<b style='background-color: #ececec;'>&lt;script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js\"&gt;&lt;/script&gt;</b>", explanation_html: "Linking Bootstrap JavaScript files from CDN for interactive components." },
    { number: 29, code_html: "<b style='background-color: #ececec;'>&lt;/body&gt;</b>", explanation_html: "Closes the <b style='background-color: #ececec;'>&lt;body&gt;</b> element." },
    { number: 30, code_html: "<b style='background-color: #ececec;'>&lt;/html&gt;</b>", explanation_html: "Closes the <b style='background-color: #ececec;'>&lt;html&gt;</b> element." }
];

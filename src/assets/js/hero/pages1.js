...
const codeHtmlExplanations = [
    { nomor: 1, code_html: "<b style='background-color: #ececec;'>&lt;!DOCTYPE html&gt;</b>", explanation_html: "Defines the document as HTML5." },
    { nomor: 2, code_html: "<b style='background-color: #ececec;'>&lt;html lang=\"en\"&gt;</b>", explanation_html: "The opening tag for the HTML element and sets the page language as English (<b style='background-color: #ececec;'>en</b>)." },
    { nomor: 3, code_html: "<b style='background-color: #ececec;'>&lt;head&gt;</b>", explanation_html: "The opening tag for the <b style='background-color: #ececec;'>&lt;head&gt;</b> section which contains metadata and links to external resources." },
    { nomor: 4, code_html: "<b style='background-color: #ececec;'>&lt;meta charset=\"UTF-8\"&gt;</b>", explanation_html: "Sets the character encoding as UTF-8 to support international characters." },
    { nomor: 5, code_html: "<b style='background-color: #ececec;'>&lt;meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"&gt;</b>", explanation_html: "Create responsive pages on mobile devices by setting the viewport to follow the width of the device's screen." },
    { nomor: 6, code_html: "<b style='background-color: #ececec;'>&lt;title&gt;Currency Converter&lt;/title&gt;</b>", explanation_html: "Set the page title as \"Currency Converter\", which will be displayed on the browser tab." },
    { nomor: 7, code_html: "<b style='background-color: #ececec;'>&lt;link rel=\"stylesheet\" href=\"style.css\"&gt;</b>", explanation_html: "Link an external CSS file named <b style='background-color: #ececec;'>style.css</b> to add custom styles to the page." },
    { nomor: 8, code_html: "<b style='background-color: #ececec;'>&lt;link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css\" rel=\"stylesheet\"&gt;</b>", explanation_html: "Connect Bootstrap CSS for additional styles and grid-based layouts." },
    { nomor: 9, code_html: "<b style='background-color: #ececec;'>&lt;link href=\"https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css\" rel=\"stylesheet\"&gt;</b>", explanation_html: "Connect Tailwind CSS for additional styles and more flexible CSS utilities." },
    { nomor: 10, code_html: "<b style='background-color: #ececec;'>&lt;body class=\"bg-gray-50\"&gt;</b>", explanation_html: "The opening tag for <b style='background-color: #ececec;'>&lt;body&gt;</b> with class <b style='background-color: #ececec;'>bg-gray-50</b> from Tailwind, which gives the page a light gray background." },
    { nomor: 11, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"container mt-5\"&gt;</b>", explanation_html: "Create a main container for the application content with a top margin (<b style='background-color: #ececec;'>mt-5</b>) using Bootstrap." },
    { nomor: 12, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"card shadow p-5 rounded-xl border-0\"&gt;</b>", explanation_html: "Create cards with shadow, padding (<b style='background-color: #ececec;'>p-5</b>), rounded corners (<b style='background-color: #ececec;'>rounded-xl</b>), and no border (<b style='background-color: #ececec;'>border-0</b>) for a smoother look." },
    { nomor: 13, code_html: "<b style='background-color: #ececec;'>&lt;h2 class=\"text-center mb-5 text-3xl font-extrabold text-gray-800\"&gt;Currency Converter&lt;/h2&gt;</b>", explanation_html: "Create the application title \"Currency Converter\" with centered text (<b style='background-color: #ececec;'>text-center</b>), bottom margin (<b style='background-color: #ececec;'>mb-5</b>), large text size (<b style='background-color: #ececec;'>text-3xl</b>), and dark gray text (text-gray-800)." },
    { nomor: 14, code_html: "<b style='background-color: #ececec;'>&lt;form id=\"converter-form\"&gt;</b>", explanation_html: "Create a form with <b style='background-color: #ececec;'>id=\"converter-form\"</b> to hold the currency conversion input and logic." },
    { nomor: 15, code_html: "<b style='background-color: #ececec;'>&lt;label for=\"amount\" class=\"form-label text-gray-700 font-medium\"&gt;Amount&lt;/label&gt;</b>", explanation_html: "Create a label for the (<b style='background-color: #ececec;'>amount</b>) input with a medium gray text style (<b style='background-color: #ececec;'>text-gray-700</b>) and medium font weight (<b style='background-color: #ececec;'>font-medium</b>)." },
    { nomor: 16, code_html: "<b style='background-color: #ececec;'>&lt;input type=\"number\" class=\"form-control rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500\" id=\"amount\" placeholder=\"Enter amount\" required&gt;</b>", explanation_html: "Input numbers for the number of conversions with Bootstrap and Tailwind styling, such as <b style='background-color: #ececec;'>rounded-lg</b> for rounded corners and <b style='background-color: #ececec;'>focus:ring-blue-500</b> for a blue focus effect." },
    { nomor: 17, code_html: "<b style='background-color: #ececec;'>&lt;label for=\"from-currency\" class=\"form-label text-gray-700 font-medium\"&gt;From&lt;/label&gt;</b>", explanation_html: "Create a label for the (<b style='background-color: #ececec;'>from-currency option</b>)." },
    { nomor: 18, code_html: "<b style='background-color: #ececec;'>&lt;select class=\"form-select rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500\" id=\"from-currency\"&gt;</b>", explanation_html: "Dropdown (<b style='background-color: #ececec;'>select</b>) element to choose the source currency, with Bootstrap and Tailwind specific styling for a cleaner look." },
    { nomor: 19, code_html: "<b style='background-color: #ececec;'>&lt;option value=\"USD\" selected&gt;USD - United States Dollar&lt;/option&gt;</b>", explanation_html: "The default option is for USD as the source currency, with a currency description." },
    { nomor: 20, code_html: "<b style='background-color: #ececec;'><i>Another line of option code inside</i> &lt;select&gt;</b>", explanation_html: "Shows other currency options such as EUR, GBP, JPY, AUD, etc." },
    { nomor: 21, code_html: "<b style='background-color: #ececec;'>&lt;label for=\"to-currency\" class=\"form-label text-gray-700 font-medium\"&gt;To&lt;/label&gt;</b>", explanation_html: "Label for the destination currency (<b style='background-color: #ececec;'>to-currency</b>) selection." },
    { nomor: 22, code_html: "<b style='background-color: #ececec;'>&lt;select class=\"form-select rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500\" id=\"to-currency\"&gt;</b>", explanation_html: "Dropdown element to select the destination currency, with classes for Bootstrap and Tailwind styling." },
    { nomor: 23, code_html: "<b style='background-color: #ececec;'><i>Another line of option code inside</i> &lt;select&gt;</b>", explanation_html: "Displays destination currency options such as EUR, GBP, JPY, AUD, etc." },
    { nomor: 24, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"text-center\"&gt;</b>", explanation_html: "Create a div to center the button element on the page." },
    { nomor: 25, code_html: "<b style='background-color: #ececec;'>&lt;button type=\"submit\" class=\"btn btn-primary btn-lg px-5 py-3 shadow-lg hover:shadow-xl rounded-full bg-blue-600 hover:bg-blue-700 transition-transform transform hover:-translate-y-1\"&gt;Convert&lt;/button&gt;</b>", explanation_html: "Buttons to convert, with Bootstrap and Tailwind styles, such as large size (<b style='background-color: #ececec;'>btn-lg</b>), blue color (<b style='background-color: #ececec;'>bg-blue-600</b>), and hover animations that give an elevation effect." },
    { nomor: 26, code_html: "<b style='background-color: #ececec;'>&lt;div id=\"result\" class=\"text-center mt-4 text-gray-800 text-xl font-bold\"&gt;&lt;/div&gt;</b>", explanation_html: "An empty <b style='background-color: #ececec;'>div</b> element with <b style='background-color: #ececec;'>id=\"result\"</b> to display the conversion results, with the text styled using Tailwind for large size (<b style='background-color: #ececec;'>text-xl</b>) and dark gray color (<b style='background-color: #ececec;'>text-gray-800</b>)." },
    { nomor: 27, code_html: "<b style='background-color: #ececec;'>&lt;script src=\"script.js\"&gt;&lt;/script&gt;</b>", explanation_html: "Linking external JavaScript file <b style='background-color: #ececec;'>script.js</b> for currency conversion logic." },
    { nomor: 28, code_html: "<b style='background-color: #ececec;'>&lt;script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js\"&gt;&lt;/script&gt;</b>", explanation_html: "Linking Bootstrap JavaScript to support Bootstrap interactive components." },
    { nomor: 29, code_html: "<b style='background-color: #ececec;'>&lt;/body&gt;</b>", explanation_html: "Closing the <b style='background-color: #ececec;'>&lt;body&gt;</b> tag." },
    { nomor: 30, code_html: "<b style='background-color: #ececec;'>&lt;/html&gt;</b>", explanation_html: "Closing the <b style='background-color: #ececec;'>&lt;html&gt;</b> tag." }
];
...
const codeJsExplanations = [
    { nomor: 1, code_js: "<b style='background-color: #ececec;'>document.getElementById('converter-form').addEventListener('submit', function(e) {</b>", explanation_js: "Added an event listener for the form with the id <b style='background-color: #ececec;'>converter-form</b> to handle the <b style='background-color: #ececec;'>submit</b> event." },
    { nomor: 2, code_js: "<b style='background-color: #ececec;'>e.preventDefault();</b>", explanation_js: "Prevents the default form submit action to prevent page reload." },
    { nomor: 3, code_js: "<b style='background-color: #ececec;'>const amount = document.getElementById('amount').value;</b>", explanation_js: "Gets the amount value from the input with the id <b style='background-color: #ececec;'>amount</b>." },
    { nomor: 4, code_js: "<b style='background-color: #ececec;'>const fromCurrency = document.getElementById('from-currency').value;</b>", explanation_js: "Gets the source currency value from the input element with id <b style='background-color: #ececec;'>from-currency</b>." },
    { nomor: 5, code_js: "<b style='background-color: #ececec;'>const toCurrency = document.getElementById('to-currency').value;</b>", explanation_js: "Gets the target currency value from the input element with id <b style='background-color: #ececec;'>to-currency</b>." },
    { nomor: 6, code_js: "<b style='background-color: #ececec;'>const exchangeRates = { ... };</b>", explanation_js: "Stores currency exchange rates in an <b style='background-color: #ececec;'>exchangeRates</b> object, where each currency has an exchange rate against every other currency." },
    { nomor: 7, code_js: "<b style='background-color: #ececec;'>const result = (amount * exchangeRates[fromCurrency][toCurrency]).toFixed(2);</b>", explanation_js: "Calculates the conversion result by multiplying the (<b style='background-color: #ececec;'>amount</b>) by the exchange rate from the source currency to the destination currency. Use <b style='background-color: #ececec;'>.toFixed(2)</b> to limit the result to 2 decimal places." },
    { nomor: 8, code_js: "<b style='background-color: #ececec;'>document.getElementById('result').innerHTML = ${amount} ${fromCurrency} = ${result} ${toCurrency};</b>", explanation_js: "Displays the conversion <b style='background-color: #ececec;'>result</b> in an element with the id result, with a format that shows the amount, source currency, conversion result, and destination currency." }
];

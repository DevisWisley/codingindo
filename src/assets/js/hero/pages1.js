...
const codeHtmlExplanations = [
    { number: 1, code_html: "<b style='background-color: #ececec;'>&lt;!DOCTYPE html&gt;</b>", explanation_html: "Defines the document as HTML5." },
    { number: 2, code_html: "<b style='background-color: #ececec;'>&lt;html lang=\"en\"&gt;</b>", explanation_html: "The opening tag for the HTML element and sets the page language as English (<b style='background-color: #ececec;'>en</b>)." },
    { number: 3, code_html: "<b style='background-color: #ececec;'>&lt;head&gt;</b>", explanation_html: "The opening tag for the <b style='background-color: #ececec;'>&lt;head&gt;</b> section which contains metadata and links to external resources." },
    { number: 4, code_html: "<b style='background-color: #ececec;'>&lt;meta charset=\"UTF-8\"&gt;</b>", explanation_html: "Sets the character encoding as UTF-8 to support international characters." },
    { number: 5, code_html: "<b style='background-color: #ececec;'>&lt;meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"&gt;</b>", explanation_html: "Create responsive pages on mobile devices by setting the viewport to follow the width of the device's screen." },
    { number: 6, code_html: "<b style='background-color: #ececec;'>&lt;title&gt;Currency Converter&lt;/title&gt;</b>", explanation_html: "Set the page title as \"Currency Converter\", which will be displayed on the browser tab." },
    { number: 7, code_html: "<b style='background-color: #ececec;'>&lt;link rel=\"stylesheet\" href=\"style.css\"&gt;</b>", explanation_html: "Link an external CSS file named <b style='background-color: #ececec;'>style.css</b> to add custom styles to the page." },
    { number: 8, code_html: "<b style='background-color: #ececec;'>&lt;link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css\" rel=\"stylesheet\"&gt;</b>", explanation_html: "Connect Bootstrap CSS for additional styles and grid-based layouts." },
    { number: 9, code_html: "<b style='background-color: #ececec;'>&lt;link href=\"https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css\" rel=\"stylesheet\"&gt;</b>", explanation_html: "Connect Tailwind CSS for additional styles and more flexible CSS utilities." },
    { number: 10, code_html: "<b style='background-color: #ececec;'>&lt;body class=\"bg-gray-50\"&gt;</b>", explanation_html: "The opening tag for <b style='background-color: #ececec;'>&lt;body&gt;</b> with class <b style='background-color: #ececec;'>bg-gray-50</b> from Tailwind, which gives the page a light gray background." },
    { number: 11, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"container mt-5\"&gt;</b>", explanation_html: "Create a main container for the application content with a top margin (<b style='background-color: #ececec;'>mt-5</b>) using Bootstrap." },
    { number: 12, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"card shadow p-5 rounded-xl border-0\"&gt;</b>", explanation_html: "Create cards with shadow, padding (<b style='background-color: #ececec;'>p-5</b>), rounded corners (<b style='background-color: #ececec;'>rounded-xl</b>), and no border (<b style='background-color: #ececec;'>border-0</b>) for a smoother look." },
    { number: 13, code_html: "<b style='background-color: #ececec;'>&lt;h2 class=\"text-center mb-5 text-3xl font-extrabold text-gray-800\"&gt;Currency Converter&lt;/h2&gt;</b>", explanation_html: "Create the application title \"Currency Converter\" with centered text (<b style='background-color: #ececec;'>text-center</b>), bottom margin (<b style='background-color: #ececec;'>mb-5</b>), large text size (<b style='background-color: #ececec;'>text-3xl</b>), and dark gray text (text-gray-800)." },
    { number: 14, code_html: "<b style='background-color: #ececec;'>&lt;form id=\"converter-form\"&gt;</b>", explanation_html: "Create a form with <b style='background-color: #ececec;'>id=\"converter-form\"</b> to hold the currency conversion input and logic." },
    ...
    { number: 19, code_html: "<b style='background-color: #ececec;'>&lt;option value=\"USD\" selected&gt;USD - United States Dollar&lt;/option&gt;</b>", explanation_html: "The default option is for USD as the source currency, with a currency description." },
    { number: 20, code_html: "<b style='background-color: #ececec;'><i>Another line of option code inside</i> &lt;select&gt;</b>", explanation_html: "Shows other currency options such as EUR, GBP, JPY, AUD, etc." },
    { number: 21, code_html: "<b style='background-color: #ececec;'>&lt;label for=\"to-currency\" class=\"form-label text-gray-700 font-medium\"&gt;To&lt;/label&gt;</b>", explanation_html: "Label for the destination currency (<b style='background-color: #ececec;'>to-currency</b>) selection." },
    { number: 22, code_html: "<b style='background-color: #ececec;'>&lt;select class=\"form-select rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500\" id=\"to-currency\"&gt;</b>", explanation_html: "Dropdown element to select the destination currency, with classes for Bootstrap and Tailwind styling." },
    { number: 23, code_html: "<b style='background-color: #ececec;'><i>Another line of option code inside</i> &lt;select&gt;</b>", explanation_html: "Displays destination currency options such as EUR, GBP, JPY, AUD, etc." },
    { number: 24, code_html: "<b style='background-color: #ececec;'>&lt;div class=\"text-center\"&gt;</b>", explanation_html: "Create a div to center the button element on the page." },
    ...
    { number: 27, code_html: "<b style='background-color: #ececec;'>&lt;script src=\"script.js\"&gt;&lt;/script&gt;</b>", explanation_html: "Linking external JavaScript file <b style='background-color: #ececec;'>script.js</b> for currency conversion logic." },
    { number: 28, code_html: "<b style='background-color: #ececec;'>&lt;script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js\"&gt;&lt;/script&gt;</b>", explanation_html: "Linking Bootstrap JavaScript to support Bootstrap interactive components." },
    { number: 29, code_html: "<b style='background-color: #ececec;'>&lt;/body&gt;</b>", explanation_html: "Closing the <b style='background-color: #ececec;'>&lt;body&gt;</b> tag." },
    { number: 30, code_html: "<b style='background-color: #ececec;'>&lt;/html&gt;</b>", explanation_html: "Closing the <b style='background-color: #ececec;'>&lt;html&gt;</b> tag." }
];
...
const codeCssExplanations = [
    { number: 1, code_css: "<b style='background-color: #ececec;'>body { font-family: 'Inter', sans-serif; }</b>", explanation_css: "Sets the font for the <b style='background-color: #ececec;'>&lt;body&gt;</b> element using the 'Inter' font with a <b style='background-color: #ececec;'>sans-serif</b> alternative." },
    ...
    { number: 5, code_css: "<b style='background-color: #ececec;'>.btn { font-size: 1.125rem; }</b>", explanation_css: "Set the font size of the element with the <b style='background-color: #ececec;'>btn</b> class to 1.125 rem to increase readability on the button." },
    { number: 6, code_css: "<b style='background-color: #ececec;'>#converter-form { max-width: 500px; margin: 0 auto; }</b>", explanation_css: "Set the element with <b style='background-color: #ececec;'>id=\"converter-form\"</b> to have a maximum width of 500px and centered on the page (<b style='background-color: #ececec;'>margin: 0 auto</b>)." }
];
...
const codeJsExplanations = [
    { number: 1, code_js: "<b style='background-color: #ececec;'>document.getElementById('converter-form').addEventListener('submit', function(e) {</b>", explanation_js: "Added an event listener for the form with the id <b style='background-color: #ececec;'>converter-form</b> to handle the <b style='background-color: #ececec;'>submit</b> event." },
    { number: 2, code_js: "<b style='background-color: #ececec;'>e.preventDefault();</b>", explanation_js: "Prevents the default form submit action to prevent page reload." },
    { number: 3, code_js: "<b style='background-color: #ececec;'>const amount = document.getElementById('amount').value;</b>", explanation_js: "Gets the amount value from the input with the id <b style='background-color: #ececec;'>amount</b>." },
    { number: 4, code_js: "<b style='background-color: #ececec;'>const fromCurrency = document.getElementById('from-currency').value;</b>", explanation_js: "Gets the source currency value from the input element with id <b style='background-color: #ececec;'>from-currency</b>." },
    { number: 5, code_js: "<b style='background-color: #ececec;'>const toCurrency = document.getElementById('to-currency').value;</b>", explanation_js: "Gets the target currency value from the input element with id <b style='background-color: #ececec;'>to-currency</b>." },
    { number: 6, code_js: "<b style='background-color: #ececec;'>const exchangeRates = { ... };</b>", explanation_js: "Stores currency exchange rates in an <b style='background-color: #ececec;'>exchangeRates</b> object, where each currency has an exchange rate against every other currency." },
